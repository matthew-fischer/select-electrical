...
const manuals = [
  { brand: 'WEG', label: "User's Manual",             url: '/select-electrical/datasheets/CFW500/WEG-CFW500-USERS-MANUAL.pdf' },
  { brand: 'WEG', label: 'Control Brochure',          url: '/select-electrical/datasheets/CFW500/WEG-CFW500-CONTROL-BROCHURE.pdf' },
  { brand: 'WEG', label: 'Quick Parameter Reference', url: '/select-electrical/datasheets/CFW500/WEG-CFW500-QUICK-PARAMETER-REFERENCE.pdf' },
]
