...
export default function CFW100() {
  return (
    <VFDProductPage
      ...
      image="/images/low-voltage/cfw100.png"
      tagline="An extremely compact, high-performance VFD"
      description="The CFW100 is the most compact VFD in the WEG lineup. Plug-and-play operation with surface or DIN rail mounting makes it ideal for space-constrained applications."
      technicalSpecsLink="https://pamensky.com/cfw100.html"
      features={[
