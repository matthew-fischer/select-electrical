...
const websiteLinks = [
  { tag: 'Mirus', label: 'Mirus Product Page', url: 'https://www.mirusinternational.com/inversine.php'},
  { tag: 'MTE',  label: 'MTE Product Page', url: 'https://mtecorp.com/products/sinewave-filters/'},
]
