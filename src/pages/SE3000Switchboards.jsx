...
const switchImages = [
  { src: '/images/hero/switchgear.jpg', alt: 'SE3000 Switchgear', fit: 'object-contain' },
  { src: '/images/hero/switchboard.jpg', alt: 'SE3000 Switchboard', fit: 'object-cover' },
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="border border-gray-100 p-6">
                ...
                <a
                  href="/datasheets/Brochures/SE-3000.pdf"
                  target="_blank"
