...
const websiteLinks = [
  { tag: 'MTE', label: 'MTE Product Page', url: 'https://mtecorp.com/products/harmonic-filters/' },
  { tag: 'Mirus', label: 'Mirus Product Page', url: 'https://www.mirusinternational.com/lineator.php' },
]
...
const allHP       = uniq(harmonicFilters.map(f => f.hp))
const allVoltage  = [ALL, '460/480V', '575/600V', '230V']
...
export default function HarmonicFilters() {
      ...
      <div className="bg-[#080808] border-b border-white/5 py-14 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-gray-400 max-w-xl">
            Filter by brand, voltage, enclosure type, and horsepower to find the correct harmonic filter SKU and specifications.
          </p>
        </div>
      </div>
